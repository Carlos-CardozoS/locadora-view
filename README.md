...
Design Responsivo (Desktop): Layout organizado para facilitar a visualização de listas e relatórios.
...
Bash
git clone https://github.com/Carlos-CardozoS/locadora-view.git
Conexão: Certifique-se de que o banco de dados (MySQL) do projeto principal esteja rodando.

Dependências: Adicione o mysql-connector-j nas bibliotecas do projeto no NetBeans.
